...
?> 
                ...
                <section class="content">
                    ...
                    <button id="submit" class="btn btn-success" name="save"><i class="icon-download icon-large"></i>Download New Share Request Report</button>
                            ...
                            $query_new_request = mysqli_query($conn,"SELECT sr.*, s.name from share_request sr left join shareholders s on s.account_no = sr.account where sr.year = $active_budget_year") or die(mysqli_error($conn));                             
                            $a = 0;	
