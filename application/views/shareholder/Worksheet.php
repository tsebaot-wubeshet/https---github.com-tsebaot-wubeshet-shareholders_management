...
class Worksheet extends BIFFwriter
{
    ...
    */
    function Worksheet($name,$index,&$activesheet,&$firstsheet,&$url_format,&$parser)
    {
        ...
        $rowmax                = 100000; // 16384 in Excel 5
        $colmax                = 256;
        $strmax                = 255;
    ...
    */
    function write_note($row, $col, $note)
    {
        ...
        $max_length     = 5000;                  // Maximun length for a NOTE record
        ...
        $length    = 0x0006 + min($note_length, 5000);
        $header    = pack("vv",   $record, $length);
        $data      = pack("vvv", $row, $col, $note_length);
        $this->_append($header.$data.substr($note, 0, 5000));
