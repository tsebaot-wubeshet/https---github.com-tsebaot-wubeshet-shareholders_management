            ...
            <li>
             ...
             <a href="#">
                      ...
                      <ul class="treeview-menu">        
                              ...
                              <li class="active"><a href="<?php echo base_url('');?>shareholder/authorize_capitalized"><i class="fa fa-angle-double-right"></i>Capitilized<?php if($row6['count(id)'] == '0'){ } else { ?><span class="badge bg-red"><?php echo $row6['count(id)']; ?><?php } ?></span></a></li>
                            </ul>
             ...
             <li class="treeview">
                        ...
                        <i class="fa fa-gear"></i>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="<?php echo base_url('');?>shareholder/blocked_report"><i class="fa fa-angle-double-right"></i>Blocked Report<?php if($blocked_report_row['count(id)'] == '0'){ } else { ?><span class="badge bg-red"><?php echo $blocked_report_row['count(id)']; ?><?php } ?></a></li>
                                <?php 
                                ...
                                ?>
                                <li class="active"><a href="<?php echo base_url('');?>shareholder/pledged_report"><i class="fa fa-angle-double-right"></i>Pledged Report<?php if($pledged_row['count(id)'] == '0'){ } else { ?><span class="badge bg-red"><?php echo $pledged_row['count(id)']; ?><?php } ?></a></li>
                                <?php 
                                ...
                                ?>
                                <li class="active"><a href="<?php echo base_url('');?>shareholder/transfer_report"><i class="fa fa-angle-double-right"></i>Transfer Report<?php if($transfer_row['count(id)'] == '0'){ } else { ?><span class="badge bg-red"><?php echo $transfer_row['count(id)']; ?><?php } ?></a></li>
                                <?php 
                                ...
                                ?>                               
                                <li class="active"><a href="<?php echo base_url('');?>shareholder/closed_report"><i class="fa fa-angle-double-right"></i>Closed Report<?php if($closed_row['count(id)'] == '0'){ } else { ?><span class="badge bg-red"><?php echo $closed_row['count(id)']; ?><?php } ?></a></li>
                                ...
                                ?>
                                <li class="active"><a href="<?php echo base_url('');?>shareholder/transfer_from_nib"><i class="fa fa-angle-double-right"></i>Transfer From NIB<?php if($transfer_nib['count(id)'] == '0'){ } else { ?><span class="badge bg-red"><?php echo $transfer_nib['count(id)']; ?><?php } ?></a></li>

                                <?php $share_request_query = $this->db->get('share_request');?>
            ...
            <i class="fa fa-th"></i>
                        ...
                        <i class="fa fa-gear"></i>
                            ...
                            <ul class="treeview-menu">
                                ...
                                ?>
                                <li class="active"><a href="<?php echo base_url('');?>shareholder/transfer_report"><i class="fa fa-angle-double-right"></i>Transfer Report<?php if($transfer_total == '0'){ } else { ?><span class="badge bg-red"><?php echo $transfer_total; ?><?php } ?></a></li>
                                <?php 
                                ...
                                ?>                               
                                <li class="active"><a href="<?php echo base_url('');?>shareholder/closed_report"><i class="fa fa-angle-double-right"></i>Closed Report<?php if($closed_total == '0'){ } else { ?><span class="badge bg-red"><?php echo $closed_total; ?><?php } ?></a></li>
                                <?php 
                                ...
                                ?>
                                <li class="active"><a href="<?php echo base_url('');?>shareholder/transfer_from_nib"><i class="fa fa-angle-double-right"></i>Transfer From NIB<?php if($transfer_nib_total == '0'){ } else { ?><span class="badge bg-red"><?php echo $transfer_nib_total; ?><?php } ?></a></li>
