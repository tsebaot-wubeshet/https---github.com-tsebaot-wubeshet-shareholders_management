                  ...
                  <?php endif ?>
                                       ...
                                       $result = mysqli_query($conn,"SELECT * FROM shareholders where id ='$id'");
                                        ...
                                        ?>
										 ...
										 <div class="form-group">
                                            <label>Total Paidup Capital</label>
                                            <input type="text" readonly name="total_paidup" id="totalpaidup" value="<?php echo $transfer1['sum(total_transfered_in_birr)'] - $transfer2['sum(total_transfered_in_birr)'] + $raised['sum(capitalized_in_birr)']; } } } ?>" class="form-control" placeholder="Enter ..."/>
                                 			<?php echo form_error('total_raised'); ?>
                                        </div>
