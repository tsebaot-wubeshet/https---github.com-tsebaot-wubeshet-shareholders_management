...
echo '<script>alert("Value date is out of budget year!");</script>';
    ...
    if($divisible > 0){
        ...
        echo 'alert("Capitalized payment amount must be divisible by share value.")';
        echo '</script>';
    }
    ...
    mysqli_query($conn,"INSERT into capitalized (account,capitalized_in_birr,capitalized_date,value_date,type,year,capitalized_status,maker) values ('$account_no','$capitalized_in_birr','$capitalized_date','$value_date',1,$year,3,$userId)") or die(mysqli_error($conn));
