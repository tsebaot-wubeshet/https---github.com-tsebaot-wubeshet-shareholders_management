			...
			<div class="col-md-6">
				<div class="box-body">
					...
					<form action="" method="POST" role="form">
						...
						<div class="form-group">
							<label> Issued Share Certificates<span class="label label-danger"><?php //echo $row['issued_share_certificate']; 
																																								?></span></label>
							<input type="text" value="<?php echo $row['issued_share_certificate']; ?>" name="issued_share" class="form-control">

						</div>
						<div class="form-group">
							<label>Prepared Share Certificate <span class="label label-danger"><?php //echo $row['prepared_share_certificate']; 
																																									?></span></label>
