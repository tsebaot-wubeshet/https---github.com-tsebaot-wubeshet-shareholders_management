      ...
      <div class="box">
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          ?>
                              ...
                              <td>&nbsp;<?php echo number_format($fetch['sum(total_transfered_in_birr)'], 2); ?><br>(<?php echo number_format($row['sum(total_transfered_in_birr)'], 2);
                                                                                                                  }
                                                                                                                } ?>)</td>
                              ...
                              ?>
                                    ...
                                    <td><?php echo number_format($share_subscribed_inbirr2 + $neg_row['sum(total_transfered_in_birr)'] - $po_row['sum(total_transfered_in_birr)'], 2);
                                      }
                                    }
                                  } ?></td>
                                    ...
                                    <td><?php
                                      ...
                                      <?php echo number_format($cap['capitalized_in_birr'], 2) . "<br>";
                                        } ?></td>
              ...
              <tbody>
                ...
                <td><?php
                    ...
                    ?><br>__________<br><?php
                          ...
                          ?><br>__________<br><?php echo $value['value_date'];
                                      } ?></td>
                ...
                <td>
                  ...
                  ?><br>__________<br><?php echo number_format($cash['capitalized_in_birr'], 2);
                                      } ?></td>
        ...
        <?php
                ...
                <td><?php
                  ...
                  <?php echo number_format($dividend_portion, 2);
                                            }
                                          }
                                        }
                                      } ?></td>
