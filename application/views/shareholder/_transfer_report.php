						...
						<table id="example1" class="table table-bordered table-striped">
							<thead>
								<tr>
									...
									<th>Amount of Share Transferred(in birr)</th>
							...
							<tbody>
								...
								$query = mysqli_query($conn, "SELECT t.*,ss.name as seller_name, sb.name as buyer_name from transfer t left join shareholders ss on ss.account_no = t.seller_account left join shareholders sb on sb.account_no = t.buyer_account WHERE status_of_transfer = 4 AND seller_account != 'NIB' order by transfer_date DESC") or die(mysqli_error($conn));
								$a = 0;
								...
								?>
									<tr>
										...
										<td><?php echo $rows['seller_name']; ?></td>
