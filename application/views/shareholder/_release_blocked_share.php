...
<?php if (isset($_GET['release_blocked_share'])) { ?>
  <div class="alert alert-success alert-dismissable">
    <i class="fa fa-ban"></i>
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          ...
          <form action="" method="POST">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                if ($num_rows == '0' && !isset($_GET['release_blocked_share'])) {
                ?>
                  <div class="alert alert-danger alert-dismissable">
                    <i class="fa fa-ban"></i>
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    Authorize the blocked shareholder first before release.
                  </div>
                <?php }
                $a = 0;
                ...
                ?>
                  <tr>
                    ...
                    <td><span class="badge bg-red"><?php echo "blocked"; ?></span></td>
                  <?php } ?>
                  </tr>
              </tbody>

              <button type="submit" name="release_share" class="btn btn-primary"><i class="glyphicon glyphicon-ok"></i> Release Shares</button>
              <br><br>
            </table>
