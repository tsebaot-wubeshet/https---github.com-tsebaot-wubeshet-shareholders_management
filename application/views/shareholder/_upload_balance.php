	...
	<div class="box box-warning">
		<div class="col-md-12">
			<div class="col-md-12">
				...
				<h6>Account Number, Total Paid Up Capital</h6>
				<hr>
			</div>
			<div class="col-md-6">
				<div class="box-body">
					...
					<form action="" method="POST" role="form" enctype='multipart/form-data'>
						<?php if (isset($_POST['submit'])) {
							...
							while (($data = fgetcsv($handle, 2000, ",")) !== FALSE) {
								$import = "INSERT into balance (account,total_paidup_capital_inbirr,year,balance_status,maker) values ('$data[0]','$data[1]',$year,3,$userId)";
