...
if (isset($_POST['submit'])) {
    ...
    while (($data = fgetcsv($handle, 2000, ",")) !== FALSE) {
        ...
        $import="INSERT into share_request (account,total_share_request,application_date,share_request_status,maker,year) values 
        ('$data[0]','$data[1]','$data[2]',3,$userId,$year)";
