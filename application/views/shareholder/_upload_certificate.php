	...
	<div class="box box-warning">
		<div class="col-md-12">
			<div class="col-md-12">
				...
				<h6>Account Number, Issued Share Certificates, Prepared Share Certificates</h6>
				<hr>
			</div>
			<div class="col-md-6">
				<div class="box-body">
					...
					<form action="" method="POST" role="form" enctype='multipart/form-data'>
						...
						if (isset($_POST['submit'])) {
							...
							while (($data = fgetcsv($handle, 2000, ",")) !== FALSE) {
								//   var_dump($data);
								$import = "INSERT into certificate (account,issued_share_certificate,prepared_share_certificate) values ('$data[0]','$data[1]','$data[2]')";
