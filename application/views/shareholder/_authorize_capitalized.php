                    ...
                    <form action="" method="POST">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($conn, "SELECT c.*, ss.name as transferred_to, sb.name as transferred_from from capitalized c left join shareholders ss on c.account=ss.account_no left join shareholders sb on sb.account_no = c.transfer_from where capitalized_status = 3 ") or die(mysqli_error($conn));
