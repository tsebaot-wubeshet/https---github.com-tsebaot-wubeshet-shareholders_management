...
class Priority_Model extends MY_Model {
	...
	public function create_priority($data){
		...
		$this->db->insert('priority_goods',$data);
	...
	public function priority_detail(){
		...
		$query = $this->db->get('priority_goods');
		
		return $query->result();
	}

	public function select_all_priority(){
	...
	public function select_priority(){
